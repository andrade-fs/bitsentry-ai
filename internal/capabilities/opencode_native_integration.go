...
func buildBitsentryAgentPrompt() string {
	return strings.Join([]string{
		...
		"",
		"Intent routing:",
		"- Intent Decision Contract (choose exactly one first action): direct_answer | use_skill | use_role | use_flow_sdr | use_flow_support | use_flow_sdd | use_flow_source-security-review | bounded_discovery_then_decide | ask_clarifying_question",
